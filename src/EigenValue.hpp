 ...
 * @brief EigenValuePtr
 */
typedef EigenValue* EigenValuePtr;

/**
 * @brief EigenValues
 */
typedef std::vector< EigenValue > EigenValues;

/**
 * @brief EigenValuesPtrs
 */
typedef std::vector< EigenValuePtr > EigenValuesPtrs;
