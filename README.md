...
+ __Ubuntu__ Release [1.3.1](https://github.com/BlueBrain/NeuroMorphoVis/releases/tag/v1.0.0) is available from this [link](https://github.com/BlueBrain/NeuroMorphoVis/releases/download/v1.3.1/blender-neuromorphovis-linux-x86_64.zip).

+ __Red Hat__ Release [1.3.1](https://github.com/BlueBrain/NeuroMorphoVis/releases/tag/v1.0.0) is available from this [link](https://github.com/BlueBrain/NeuroMorphoVis/releases/download/v1.3.1/blender-neuromorphovis-linux-x86_64.zip).

+ __Mac OS__ Release [1.3.1](https://github.com/BlueBrain/NeuroMorphoVis/releases/tag/v1.0.0) is available from this [link](https://github.com/BlueBrain/NeuroMorphoVis/releases/download/v1.3.1/blender-neuromorphovis-macOSX.dmg).

+ __Windows__ Release [1.3.1](https://github.com/BlueBrain/NeuroMorphoVis/releases/tag/v1.0.0) is available from this [link](https://github.com/BlueBrain/NeuroMorphoVis/releases/download/v1.3.1/blender-neuromorphovis-windows64.zip).
