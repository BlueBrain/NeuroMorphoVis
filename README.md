...
+ Mesh reconstruction based on skinning, union operators for artistic rendering. 
+ Mesh reconstruction with meta balls to create watertight meshes for reaction-diffusion simulations.
...
+ __Ubuntu__ Release [1.3.0](https://github.com/BlueBrain/NeuroMorphoVis/releases/tag/v1.0.0) is available from this [link](https://github.com/BlueBrain/NeuroMorphoVis/releases/download/v1.3.0/blender-neuromorphovis-linux-x86_64.zip).

+ __Red Hat__ Release [1.3.0](https://github.com/BlueBrain/NeuroMorphoVis/releases/tag/v1.0.0) is available from this [link](https://github.com/BlueBrain/NeuroMorphoVis/releases/download/v1.3.0/blender-neuromorphovis-linux-x86_64.zip).

+ __Mac OS__ Release [1.3.0](https://github.com/BlueBrain/NeuroMorphoVis/releases/tag/v1.0.0) is available from this [link](https://github.com/BlueBrain/NeuroMorphoVis/releases/download/v1.3.0/blender-neuromorphovis-macOSX.dmg).

+ __Windows__ Release [1.3.0](https://github.com/BlueBrain/NeuroMorphoVis/releases/tag/v1.0.0) is available from this [link](https://github.com/BlueBrain/NeuroMorphoVis/releases/download/v1.3.0/blender-neuromorphovis-windows64.zip).
