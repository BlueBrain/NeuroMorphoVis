...
<figcaption>A screen shot of a neuronal morphology skeleton reconstructed by  NeuroMorphoVis and sketched in the 3D viewer of Blender. Note that the neurites are tagged with different colors and the soma is reconstructed as a realistic three-dimensional profile not as a sphere.</figcaption>
</figure>
