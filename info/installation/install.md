...
NeuroMorphoVis is designed and written as a Blender _plug-in_ that can be loaded directly from its GUI. A recent Blender version must be installed on your system in advance. 
