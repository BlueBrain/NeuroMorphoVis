...
class Section:
    ...
    def get_type_string(self):
        """
        Returns a string that reflects the type of the arbor, AXON, APICAL or BASAL.
    ...
    def has_children(self):
        """
        Checks if the section has children sections or not.
    ...
    def has_parent(self):
        """
        Checks if the section has a parent section or not.
    ...
    def reorder_samples(self):
        """
        After the insertion of new samples into the section, their order is changed. Therefore, we
