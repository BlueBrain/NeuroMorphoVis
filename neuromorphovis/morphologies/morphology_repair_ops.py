...
def repair_short_sections_by_connection_to_child(section):
    ...
    primary_child = morphology_analysis_ops.get_continuation_child(section=section)
...
def repair_sections_with_single_child(section):
    ...
    if number_children == 1:
        ...
        # Apply the filter
        morphology_connection_ops.connect_single_child(section=section)
...
def repair_parents_with_smaller_radii(section):
    ...
    largest_radius_of_children_sections = \
