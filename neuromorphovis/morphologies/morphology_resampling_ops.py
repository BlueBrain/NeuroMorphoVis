...
def resample_sections(section,
    ...
    while True:
        ...
        # If the distance is greater than the resampling distance, then add a new sample midway
            ...
            auxiliary_sample = sample.Sample(point=sample_point,
...
def remove_samples_within_extent(section,
    ...
    for i, sample in enumerate(list(section.samples)):
        ...
        if sphere_ops.is_point_inside_sphere(extent_center, extent_radius, sample.point):
...
def resample_section_stem(section):
    ...
    while True:
        ...
        current_length = morphology_analysis_ops.compute_section_length_until_sample(section, i)
        ...
        distance_ratio = distance / resampling_distance
