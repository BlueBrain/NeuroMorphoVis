...
def get_section_poly_line(section,
                          ...
                          transform=None):
    """
    Gets the poly-line list or a series of points that reflect the skeleton of a single section.
...
def get_connected_sections_poly_line(section,
    ...
    """
    Gets the poly-line list or a series of points that reflect the skeleton of a group of connected
    sections along a single arbor or neurite.
    ...
    if is_continuous:
        ...
        if is_last_section:
            ...
            radius = nmv.consts.Morphology.LAST_SAMPLE_RADIUS if process_terminals else original_radius
...
def get_poly_line_length(poly_line):
    ...
    for i in range(len(poly_line_points) - 2):
