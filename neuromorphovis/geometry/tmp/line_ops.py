...
def compute_section_centroid_from_poly_line_data(poly_line_data):
    """
    Computes the centroid of a series of points given in the format of a poly-line data.
...
def create_line_object_from_data(data,
                                 ...
                                 name='line'):
    """
    Creates a line object and returns a reference to it.
...
def draw_line(point1=Vector((0, 0, 0)),
    ...
    # Create a line object and link it to the scene
    line_object = create_line_object_from_data(
...
def draw_cone_line(point1=Vector((0, 0, 0)),
                   ...
                   smoothness_factor=1):
    """
    Draws a cone line between two points, with different radii at the beginning and the end of
    the line .
...
def draw_poly_line(poly_line_data,
                   ...
                   caps=True):
    """
    Draws a poly line (connected segments of lines) with multiple formats.
