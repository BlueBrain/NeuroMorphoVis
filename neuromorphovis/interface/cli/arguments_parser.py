...
def parse_command_line_arguments():
    ...
    # Blender arguments
    ################################################################################################
    blender = parser.add_argument_group('Blender', 'Blender')
    ...
    blender.add_argument(Args.BLENDER_EXECUTABLE,
    ...
    # Input arguments
    ################################################################################################
    input = parser.add_argument_group('Input', 'Input')
    ...
    output.add_argument(Args.OUTPUT_DIRECTORY,
                        action='store', default=None,
                        help=arg_help)
    ...
    # Soma arguments
    ################################################################################################
    soma = parser.add_argument_group('Soma', 'Soma')

    # Soma stiffness
    arg_help = 'Soma surface stiffness (0.001 - 0.999). \n'\
               'Default 0.25.'
    soma.add_argument(Args.SOMA_STIFFNESS,
    ...
    arg_help = 'Soma surface subdivision level, between (3-7). \n' \
               'Default 5.'
    soma.add_argument(Args.SOMA_SUBDIVISION_LEVEL,
    ...
    ################################################################################################
    skeletonization = parser.add_argument_group('Morphology Skeleton', 'Morphology Skeleton')

    # Reconstruct the morphology of entire neuron
    arg_help = 'Reconstruct morphology skeleton for visualization or analysis.'
    skeletonization.add_argument(Args.RECONSTRUCT_MORPHOLOGY_SKELETON,
    ...
    arg_help = 'Morphology reconstruction algorithm. \n' \
               'Options: %s' % arg_options
    skeletonization.add_argument(Args.MORPHOLOGY_RECONSTRUCTION_ALGORITHM,
    ...
    arg_help = 'Morphology skeleton style. \n' \
               'Options: %s' % arg_options
    skeletonization.add_argument(Args.MORPHOLOGY_SKELETON,
    ...
    arg_help = 'Soma representation in the reconstructed morphology. \n' \
               'Options %s' % arg_options
    skeletonization.add_argument(Args.SOMA_REPRESENTATION,
                                 action='store', default='profile',
                                 help=arg_help)

    # Axon building
    arg_help = 'Ignore reconstructing the axon.'
    skeletonization.add_argument(Args.IGNORE_AXON,
                                 action='store_true', default=False,
                                 help=arg_help)

    # Basal dendrites
    arg_help = 'Ignore reconstructing basal dendrites.'
    skeletonization.add_argument(Args.IGNORE_BASAL_DENDRITES,
                                 action='store_true', default=False,
                                 help=arg_help)

    # Apical dendrite
    arg_help = 'Ignore reconstructing apical dendrites.'
    skeletonization.add_argument(Args.IGNORE_APICAL_DENDRITES,
                                 action='store_true', default=False,
                                 help=arg_help)
    ...
    arg_help = 'Maximum branching order for the axon (1, infinity). \n' \
               'Default 5.'
    skeletonization.add_argument(Args.AXON_BRANCHING_ORDER,
                                 action='store', type=int, default=5,
                                 help=arg_help)
    ...
    arg_help = 'Maximum branching order for the basal dendrites (1, infinity). \n' \
               'Default infinity.'
    skeletonization.add_argument(Args.BASAL_DENDRITES_BRANCHING_ORDER,
    ...
    arg_help = 'Maximum branching order for the apical dendrite (1, infinity).\n' \
               'Default infinity.'
    skeletonization.add_argument(Args.APICAL_DENDRITES_BRANCHING_ORDER,
                                 action='store', type=int, default=10000000000,
                                 help=arg_help)
    ...
    arg_help = 'The radii of the morphological sections.\n' \
               'Options: %s' % arg_options
    skeletonization.add_argument(Args.SECTIONS_RADII,
    ...
    arg_help = 'A scale factor used to scale the radii of the morphology.\n' \
               ...
               'Default is 1.0'
    skeletonization.add_argument(Args.RADII_SCALE_FACTOR,
    ...
    arg_help = 'A fixed radius for all morphology sections.\n'\
               ...
               'Default is 1.0'
    skeletonization.add_argument(Args.FIXED_SECTION_RADIUS,
                                 action='store', type=float, default=1.0,
                                 help=arg_help)
    ...
    ################################################################################################
    materials = parser.add_argument_group('Materials - Colors', 'Materials - Colors')

    # Soma color
    arg_help = 'Soma color'
    materials.add_argument(Args.SOMA_COLOR,
                           action='store', default='1.0_1.0_1.0',
                           help=arg_help)

    # Axon color
    arg_help = 'Axon color'
    materials.add_argument(Args.AXON_COLOR,
                           action='store', default='0.0_0.0_0.0',
                           help=arg_help)

    # Basal dendrites color
    arg_help = 'Basal dendrites color'
    materials.add_argument(Args.BASAL_DENDRITES_COLOR,
                           action='store', default='0.0_0.0_0.0',
                           help=arg_help)

    # Basal dendrites color
    arg_help = 'Apical dendrite color'
    materials.add_argument(Args.APICAL_DENDRITES_COLOR,
                           action='store', default='0.0_0.0_0.0',
                           help=arg_help)

    # Spines color
    arg_help = 'Spines color'
    materials.add_argument(Args.SPINES_COLOR,
                           action='store', default='0.0_0.0_0.0',
                           help=arg_help)

    # Nuclues color
    arg_help = 'Nucleus color'
    materials.add_argument(Args.NUCLEUS_COLOR,
                           action='store', default='1.0_1.0_1.0',
                           help=arg_help)
    ...
    arg_help = 'Articulations color. \n' \
               ...
               'Default Yellow.'
    materials.add_argument(Args.ARTICULATIONS_COLOR,
    ...
    arg_help = 'Shading mode or material. \n' \
               'Options: %s' % arg_options
    materials.add_argument(Args.SHADER,
    ...
    arg_help = 'Meshing algorithm. \n' \
               'Options: %s' % arg_options
    meshing.add_argument(Args.NEURON_MESHING_ALGORITHM,
    ...
    arg_help = 'Arbors edges. \n' \
               ...
               'Options: %s' % arg_options
    meshing.add_argument(Args.MESH_EDGES,
    ...
    arg_help = 'The surface roughness of the neuron mesh. \n' \
               'Options: %s' % arg_options
    meshing.add_argument(Args.MESH_SURFACE,
    ...
    arg_help = 'Arbors branching based on angles or radii. \n' \
               'Options : %s' % arg_options
    meshing.add_argument(Args.BRANCHING_METHOD,
    ...
    arg_help = 'Mesh tessellation factor between (0.1, 1.0).\n' \
               'Default 1.0.'
    meshing.add_argument(Args.MESH_TESSELLATION_LEVEL,
                         action='store', type=float, default=1.0,
                         help=arg_help)
    ...
    meshing.add_argument(Args.MESH_GLOBAL_COORDINATES,
                         action='store_true', default=False,
                         help=arg_help)
    ...
    arg_help = 'The rendering view of the skeleton for the skeleton. \n' \
               'Options: %s' % arg_options
    rendering.add_argument(Args.RENDERING_VIEW,
    ...
    arg_help = 'The camera direction. \n' \
               'Options: %s' % arg_options
    rendering.add_argument(Args.CAMERA_VIEW,
    ...
    arg_help = 'Close up dimensions (the view around the soma in microns). \n' \
               ...
               'Default 20.'
    rendering.add_argument(Args.CLOSE_UP_DIMENSIONS,
    ...
    arg_help = 'Base resolution of full view images (wide-shot or mid-shot). \n' \
               'Default 1024.'
    rendering.add_argument(Args.FULL_VIEW_RESOLUTION,
    ...
    arg_help = 'Base resolution of close-up images. \n' \
               'Valid only when the --rendering-view = close-up. \n' \
               'Default 512.'
    rendering.add_argument(Args.CLOSE_UP_RESOLUTION,
    ...
    arg_help = 'A factor used to scale the resolution of the image. \n' \
               ...
               'Default 1.'
    rendering.add_argument(Args.RESOLUTION_SCALE_FACTOR,
                           action='store', type=float, default=1.0,
                           help=arg_help)
    ...
    # Execution arguments
    ################################################################################################
    execution = parser.add_argument_group('Execution', 'Execution')

    # Execution node
    arg_options = ['(local)', 'cluster']
    arg_help = 'Execution is local or using cluster nodes. \n' \
               'Options: %s' % arg_options
    execution.add_argument(Args.EXECUTION_NODE,
    ...
    arg_help = 'Number of execution cores on cluster. \n' \
               'Default 256.'
    execution.add_argument(Args.NUMBER_CORES,
    ...
    arg_help = 'The granularity of the jobs running on the cluster. \n' \
               'Options: %s' % arg_options
    execution.add_argument(Args.JOB_GRANULARITY,
    ...
    ################################################################################################
    analysis = parser.add_argument_group('Analysis', 'Analysis')

    # Morphology analysis
    arg_help = 'Analyze the morphology skeleton and report the artifacts.'
    analysis.add_argument(Args.ANALYZE_MORPHOLOGY,
                          action='store_true', default=False,
                          help=arg_help)
