...
items = [
    ...
    AnalysisItem(variable='TotalNumberSamples',
                 ...
                 kernel=analyse_total_number_samples,
    ...
    AnalysisItem(variable='MinNumberSamplePerSection',
                 ...
                 kernel=analyze_minimum_number_samples_per_section,
    ...
    AnalysisItem(variable='MaxNumberSamplePerSection',
                 ...
                 kernel=analyze_maximum_number_samples_per_section,
    ...
    AnalysisItem(variable='AvgNumberSamplePerSection',
                 ...
                 kernel=analyze_average_number_samples_per_section,
