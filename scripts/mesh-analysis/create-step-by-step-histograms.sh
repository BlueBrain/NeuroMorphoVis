...
# Input directory
INPUT_DIRECTORY='/ssd2/ultraliser/ultraliser-stats-figures/step-by-step-analysis'

# Output directory
OUTPUT_DIRECTORY='/ssd2/ultraliser/ultraliser-stats-figures/step-by-step-analysis/output'
