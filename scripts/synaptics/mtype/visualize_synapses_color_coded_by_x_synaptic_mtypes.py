...
def parse_command_line_arguments():
    ...
    arg_help = 'Display the synapses based on the mtypes of the pre- or the post-synaptic neurons'
...
if __name__ == "__main__":
    ...
    if args.pre_or_post == 'pre':
        ...
        synapse_groups = nmv.bbp.create_color_coded_synapse_groups_by_post_mtype(
