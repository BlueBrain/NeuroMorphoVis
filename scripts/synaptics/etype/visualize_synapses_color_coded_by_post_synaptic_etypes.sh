...
# Color-map of the synapses based on their etype
SYNAPSES_COLOR_MAP='/gpfs/bbp.cscs.ch/project/proj3/projects-data/synaptics/ex-3/post-etypes.colors'
...
####################################################################################################
$BLENDER -b --verbose 0 --python visualize_synapses_color_coded_by_x_synaptic_etypes.py --          \
