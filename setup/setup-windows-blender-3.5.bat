...
:: ####################################################################################################
set "reference=blender-3.5.0-windows-x64"

:: ####################################################################################################
:: Download Blender and install it 
:: ####################################################################################################
REM Blender Zip file URL 
set "blender_url=https://download.blender.org/release/Blender3.5/%reference%.zip"
...
set "add_on_path=%CD%\%reference%\3.5\scripts\addons"
...
:: ####################################################################################################
REM Python path
set "python_path= %CD%\%reference%\3.5\python\bin\python.exe"
