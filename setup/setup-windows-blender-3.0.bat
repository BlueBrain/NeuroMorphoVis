...
:: ####################################################################################################
set "reference=blender-3.0.0-windows-x64"

:: ####################################################################################################
:: Download Blender and install it 
:: ####################################################################################################
REM Blender Zip file URL 
set "blender_url=https://download.blender.org/release/Blender3.0/%reference%.zip"
...
set "add_on_path=%CD%\%reference%\3.0\scripts\addons"
...
:: ####################################################################################################
REM Python path
set "python_path= %CD%\%reference%\3.0\python\bin\python.exe"
