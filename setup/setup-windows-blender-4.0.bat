...
:: ####################################################################################################
set "reference=blender-4.0.0-windows-x64"

:: ####################################################################################################
:: Download Blender and install it 
:: ####################################################################################################
REM Blender Zip file URL 
set "blender_url=https://download.blender.org/release/Blender4.0/%reference%.zip"
...
set "add_on_path=%CD%\%reference%\4.0\scripts\addons"
...
:: ####################################################################################################
REM Python path
set "python_path= %CD%\%reference%\4.0\python\bin\python.exe"
