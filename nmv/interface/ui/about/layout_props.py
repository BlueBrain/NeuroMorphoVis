...
def draw_layout_props(panel, scene, options):
    ...
    credits_column.label(text='Marwan Abdellah', icon='USER')
    credits_column.separator()
    credits_column.label(text='Credits')
    credits_column.label(text='Juan Hernando', icon='USER')
    credits_column.label(text='Caitlin Monney', icon='USER')
    credits_column.label(text='Nadir Roman', icon='USER')
    credits_column.label(text='Alessandro Foni', icon='USER')
    credits_column.label(text='Elvis Boci', icon='USER')
    credits_column.separator()

    credits_column.label(text='Advisors')
    credits_column.label(text='Ahmet Bilgili', icon='USER')
    credits_column.label(text='Stefan Eilemann', icon='USER')
    credits_column.label(text='Henry Markram', icon='USER')
    credits_column.label(text='Felix Schürmann', icon='USER')
    credits_column.separator()
    credits_column.label(text='Acknowledgements')
    credits_column.label(text='Pawel Podhajski', icon='USER')
    credits_column.label(text='Danny Dyer', icon='USER')
    credits_column.label(text='Alan Garner', icon='USER')
    credits_column.separator()
