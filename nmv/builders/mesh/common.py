...
def modify_morphology_skeleton(builder):
    ...
    if builder.options.mesh.skeletonization == nmv.enums.Skeleton.Style.TAPERED or \
       builder.options.mesh.skeletonization == nmv.enums.Skeleton.Style.TAPERED_ZIGZAG:
        nmv.skeleton.ops.apply_operation_to_morphology(
            *[builder.morphology, nmv.skeleton.ops.taper_section])

    # Zigzag the sections if required
    if builder.options.mesh.skeletonization == nmv.enums.Skeleton.Style.ZIGZAG or \
       builder.options.mesh.skeletonization == nmv.enums.Skeleton.Style.PLANAR_ZIGZAG or \
       builder.options.mesh.skeletonization == nmv.enums.Skeleton.Style.TAPERED_ZIGZAG:
        nmv.skeleton.ops.apply_operation_to_morphology(
            *[builder.morphology, nmv.skeleton.ops.zigzag_section])

    if builder.options.mesh.skeletonization == nmv.enums.Skeleton.Style.PLANAR:
        nmv.skeleton.ops.apply_operation_to_morphology(
